...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: bqYqmq89i-Zu/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___514Mg)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__e0GEm)}>
            <div
              className={classNames(
                projectcss.all,
