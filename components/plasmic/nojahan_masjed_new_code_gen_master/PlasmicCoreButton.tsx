...
import sty from "./PlasmicCoreButton.module.css"; // plasmic-import: XVno6UkYv7_l/css

import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: izBw40asej60/icon
import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: QmoLZEu7z-27/icon

createPlasmicElementProxy;

export type PlasmicCoreButton__VariantMembers = {
...
export type PlasmicCoreButton__VariantsArgs = {
...
type VariantPropType = keyof PlasmicCoreButton__VariantsArgs;
export const PlasmicCoreButton__VariantProps = new Array<VariantPropType>(
  "color",
  "type",
  "size",
  "iconStart",
...
export type PlasmicCoreButton__ArgsType = {
  disabled?: boolean;
  submitsForm?: boolean;
  resetsForm?: boolean;
  ariaLabel?: string;
...
type ArgPropType = keyof PlasmicCoreButton__ArgsType;
export const PlasmicCoreButton__ArgProps = new Array<ArgPropType>(
  "disabled",
  "submitsForm",
  "resetsForm",
  "ariaLabel",
...
export type PlasmicCoreButton__OverridesType = {
...
export interface DefaultCoreButtonProps {
  disabled?: boolean;
  submitsForm?: boolean;
  resetsForm?: boolean;
  ariaLabel?: string;
...
function PlasmicCoreButton__RenderFunc(props: {
  variants: PlasmicCoreButton__VariantsArgs;
  args: PlasmicCoreButton__ArgsType;
  overrides: PlasmicCoreButton__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__f194M, {
          [sty.freeBoxcolor_neutral__f194MxFkIt]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxroundedFull__f194Mf72Cx]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__f194Mz81Z6]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__f194MrIPgC]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__f194MwlHjZ]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__f194MvliDo]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__f194M9UmYl]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__f194M9UmYlEd5Ul]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__hix1B, {
            [sty.freeBoxcolor_neutral__hix1BxFkIt]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__hix1BxFkItCs1Ra]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__hix1BvVj65]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__hix1Bz81Z6]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__hix1BwlHjZ]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__hix1BvliDo]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__hix1B9UmYl]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__hhe6U)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__iIbj, {
            [sty.freeBoxiconEnd__iIbjC3BVu]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__iIbjZ81Z6]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__iIbjwlHjZ]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__iIbjvliDo]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__acs1X)}
                role={"img"}
              />
            ),
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicCoreButton__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicCoreButton__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      PlasmicCoreButton__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicCoreButton__ArgProps,
          internalVariantPropNames: PlasmicCoreButton__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicCoreButton__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicCoreButton";
  } else {
    func.displayName = `PlasmicCoreButton.${nodeName}`;
  }
  return func;
}

export const PlasmicCoreButton = Object.assign(
  // Top-level PlasmicCoreButton renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicCoreButton
    internalVariantProps: PlasmicCoreButton__VariantProps,
    internalArgProps: PlasmicCoreButton__ArgProps
  }
);

export default PlasmicCoreButton;
/* prettier-ignore-end */
