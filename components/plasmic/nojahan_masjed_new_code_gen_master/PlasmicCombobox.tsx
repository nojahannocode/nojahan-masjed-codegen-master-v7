...
import Description from "../../Description"; // plasmic-import: GdEf_iBiofPc/component
import MenuPopover from "../../MenuPopover"; // plasmic-import: EwPsFnWTlIqQ/component
import MenuItem from "../../MenuItem"; // plasmic-import: bqYqmq89i-Zu/component
import MenuSection from "../../MenuSection"; // plasmic-import: nkfI-aNzxOy9/component
...
import sty from "./PlasmicCombobox.module.css"; // plasmic-import: h3ANggJrUJFK/css
...
function PlasmicCombobox__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox___032A2)}>
        {(() => {
          const child$Props = {
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox__jiLs)}>
            <ChevronDownIcon
