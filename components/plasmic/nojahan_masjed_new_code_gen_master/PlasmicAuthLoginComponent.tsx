        ...
        >
          ...
          <AntdButton
            ...
            onClick={async () => {
              ...
              $steps["httpPostOtp"] = true
                ? (() => {
                    const actionArgs = {
                      dataOp: {
                        sourceId: "hfKFoF6NHFakDLEE3BFPLz",
                        opId: "9899880f-6314-49bb-bc59-f0a5bbd74ce9",
                        userArgs: {
                          body: [$state.mobile.value, $props.roleProp]
                        },
                        cacheKey: null,
                ...
                : undefined;
              if (
                $steps["httpPostOtp"] != null &&
                typeof $steps["httpPostOtp"] === "object" &&
                typeof $steps["httpPostOtp"].then === "function"
              ) {
                $steps["httpPostOtp"] = await $steps["httpPostOtp"];
              }

              $steps["updateStepVerify"] = $steps.httpPostOtp?.data?.response
                ?.status
                ? (() => {
                    const actionArgs = {
                      variable: {
              ...
              $steps["shoeNotifError"] = !$steps.httpPostOtp?.data?.response
                ?.status
                ? (() => {
                    const actionArgs = {
                      args: [
                        ...
                        (() => {
                          try {
                            return (
                              $steps.httpPostOtp?.data?.response?.status ??
                ...
                : undefined;
              if (
                $steps["shoeNotifError"] != null &&
                typeof $steps["shoeNotifError"] === "object" &&
                typeof $steps["shoeNotifError"].then === "function"
              ) {
                $steps["shoeNotifError"] = await $steps["shoeNotifError"];
              }

              $steps["showSuccessMessage"] = $steps.httpPostOtp?.data?.response
                ?.status
                ? (() => {
                    const actionArgs = {
                      args: [
                        ...
                        (() => {
                          try {
                            return $steps.httpPostOtp?.data?.response?.message;
                          } catch (e) {
                            if (
                              e instanceof TypeError ||
                              e?.plasmicType === "PlasmicUndefinedDataError"
              ...
              $steps["setCurrenPageLoginDetail"] = true
                ? (() => {
                    const actionArgs = {
                      variable: {
                        objRoot: $state,
                      ...
                      operation: 0,
                      value: $steps.httpPostOtp?.data?.response
                    };
                    return (({ variable, value, startIndex, deleteCount }) => {
                      if (!variable) {
                        return;
                ...
                : undefined;
              if (
                $steps["setCurrenPageLoginDetail"] != null &&
                typeof $steps["setCurrenPageLoginDetail"] === "object" &&
                typeof $steps["setCurrenPageLoginDetail"].then === "function"
              ) {
                $steps["setCurrenPageLoginDetail"] = await $steps[
                  "setCurrenPageLoginDetail"
                ];
              }
            }}
          >
        ...
        >
          ...
          <AntdButton
            ...
            onClick={async () => {
              ...
              $steps["httpOtpVerify"] = true
                ? (() => {
                    const actionArgs = {
                      dataOp: {
                        sourceId: "hfKFoF6NHFakDLEE3BFPLz",
                        opId: "27da7baf-56e4-4ba6-8d26-50fd4c09a953",
                        userArgs: {
                          body: [
                            $state.mobile.value,
                            $state.otp.value,
                ...
                : undefined;
              if (
                $steps["httpOtpVerify"] != null &&
                typeof $steps["httpOtpVerify"] === "object" &&
                typeof $steps["httpOtpVerify"].then === "function"
              ) {
                $steps["httpOtpVerify"] = await $steps["httpOtpVerify"];
              }

              $steps["setOtpVar"] = true
                ? (() => {
                    const actionArgs = {
                      variable: {
                        objRoot: $state,
                      ...
                      operation: 0,
                      value: $steps.httpOtpVerify.data.response
                    };
                    return (({ variable, value, startIndex, deleteCount }) => {
                      if (!variable) {
                        return;
                ...
                : undefined;
              if (
                $steps["setOtpVar"] != null &&
                typeof $steps["setOtpVar"] === "object" &&
                typeof $steps["setOtpVar"].then === "function"
              ) {
                $steps["setOtpVar"] = await $steps["setOtpVar"];
              }

              $steps["showNotification"] = $state.httpOtpDetailVar.status
                ? (() => {
                    const actionArgs = {
                      args: [
                        "success",
                        (() => {
                          try {
                            return $state.httpOtpDetailVar.messsage;
                          } catch (e) {
                            if (
                              e instanceof TypeError ||
                              e?.plasmicType === "PlasmicUndefinedDataError"
              ...
              $steps["showErrorMsg"] = !$state.httpOtpDetailVar.status
                ? (() => {
                    const actionArgs = {
                      args: [
                        "error",
                ...
                : undefined;
              if (
                $steps["showErrorMsg"] != null &&
                typeof $steps["showErrorMsg"] === "object" &&
                typeof $steps["showErrorMsg"].then === "function"
              ) {
                $steps["showErrorMsg"] = await $steps["showErrorMsg"];
              }
                    ...
                    const actionArgs = {
                      customFunction: async () => {
                        return localStorage.setItem(
                          "AuthorizationDetail",
                          JSON.stringify($state.httpOtpDetailVar)
                        );
                      }
                    };
              ...
              $steps["runIsLoginSuccessFn"] = true
                ? (() => {
                    const actionArgs = {
                      eventRef: $props["isLoginSuccessFn"],
                      args: [
                        (() => {
                          try {
                            return $state.httpOtpDetailVar.status;
                          } catch (e) {
                            if (
                              e instanceof TypeError ||
                              e?.plasmicType === "PlasmicUndefinedDataError"
                ...
                : undefined;
              if (
                $steps["runIsLoginSuccessFn"] != null &&
                typeof $steps["runIsLoginSuccessFn"] === "object" &&
                typeof $steps["runIsLoginSuccessFn"].then === "function"
              ) {
                $steps["runIsLoginSuccessFn"] = await $steps[
                  "runIsLoginSuccessFn"
                ];
              }
